...
export class ManageOrgRegSuccessComponent extends BaseComponent implements OnInit {
  ...
  constructor(private dataService: dataService,private sessionService:SessionService, public router: Router, protected uiStore: Store<UIState>, protected viewportScroller: ViewportScroller, protected scrollHelper: ScrollHelper, private dataLayerService: DataLayerService) {
